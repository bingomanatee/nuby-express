...
var get_param = require('get_param.js');
var get_params = require('get_params.js');
var prop_extend = require('prop_extend.js');
...
Req_State.prototype = {
    ...
    action_event:function (event_name, on_done) {
        var action_event = require('../action_event');

        action_event.handle(this, event_name, on_done);
    },
