...
module.exports = function (pathname) {
  ...
  //  console.log('READING DEFAULT PUBLIC PATHS');

    var static_routes = this.get_resources('static_route').concat(_default_public_static_route.call(this));
   if (_DEBUG) console.log('static routes: %s', util.inspect(static_routes));
  ...
  //      console.log('Pathname: %s, proper_path: %s', pathname, path_suffix);
    ...
    //        console.log('route_prefix: %s, path_suffix_prefix: %s; returning false ', route_prefix, path_suffix_prefix);
            return false;
        }
