    ...
    return new Path_Handler({
        ...
        execute:function (props, callback) {
            ...
            try {
                ...
                // note there are some legitimate reasons why this might not load
                // for instance if you put subfolders in resource folders for organizing libraries. 
                console.log('cannot load %s: %s', match_path, err.message);
                callback();
            }
